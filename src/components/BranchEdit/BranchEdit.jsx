...
const BranchEdit = ({branchData, setEditBoxOpen, setEditSuccess}) => {
  ...
  const submitHandler = (event) => {
    ...
    let data = JSON.stringify({
        "branchId" : formData._id || formData.id,
    ...
    let config = {
      ...
      url: `${import.meta.env.VITE_REACT_APP_ENDPOINT}/branch/update`,
      headers: { 
        'Authorization': token, 
      ...
      >
        ...
        <div className="flex flex-col w-[900px]">
          ...
          <IoClose size={35} className="absolute right-[220px] text-[#EC2752] transition ease hover:rotate-[360deg] duration-500" onClick={closeHandler}/>
            <p className="text-4xl font-bold">Update Branch Details 
            </p>
